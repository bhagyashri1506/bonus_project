        ...
        <div className='t3'>
            <div id="page">
                <div class="page-content pb-0">
                    <div data-card-height="cover-full" class="card mb-0 d-flex align-items-center justify-content-center">
                        <div class="card-center">
                            ...
                            <div class="content px-4">
                                ...
                                <p class="text-center my-4 font-13 color-white">Didn't get your code? <a href=".#" style={{color:"#D4A948"}}>Resend Code</a></p>
                                <a href=".#" data-back-button class="btn btn-full font-600 font-15 gradient-highlight mt-4 rounded-xs" onClick={e => {
                                    e.preventDefault()
                                    verify()
                                }}>VERIFY ACCOUNT</a>
                            </div>
