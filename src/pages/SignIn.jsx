            ...
            <div id="page">
                <div class="page-content pb-0">
                    <div data-card-height="cover-full" class="card mb-0 mx-0">
                        <div className="t1" style={{position:"sticky", top:"0px", zIndex:"3"}}>
                            <Header />
                        </div>
                        <div className='login_bg'>
                            <img src={require("../images/login-page.png")} alt="" />
                        </div>
                       
                        <div class="card-center px-4 pt-3">
                            <div>
                                <h1 class="font-23 font-700 mb-2" style={{ color: 'white' }}>Login</h1>
                            </div>
                        ...
                        <div class="card-overlay bg-black" style={{height:"1000px"}}></div>
                    </div>
                        <div className="t1">
                            <Footer />
                            <MenuSidebar />
