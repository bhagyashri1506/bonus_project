                ...
                <div class="page-content footer-clear">
                    ...
                    <div class="content t3" id="tab-group-1" style={{ margin: "20px 15px 20px 15px" }}>
                        <div class="tab-controls tabs-medium tabs-rounded" data-highlight="bg-highlight" style={{padding:"6px"}}>
                            <a href="#" style={{margin:0,width:"48%"}} data-active={active == 1 ? true : false} className={`${active == 1 ? "bg-highlight" : ""}`} data-bs-toggle="collapse" data-bs-target="#tab-1" onClick={() => setActive(1)}>Transaction History</a>
                            <a href="#" style={{margin:0,width:"48%"}} data-active={active == 2 ? true : false} className={`${active == 2 ? "bg-highlight" : ""}`} data-bs-toggle="collapse" data-bs-target="#tab-2" onClick={() => setActive(2)}>Bet History</a>
                        </div>
